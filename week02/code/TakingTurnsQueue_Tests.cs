...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue was adding to front instead of back, causing incorrect queue order
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: PersonQueue.Enqueue was adding to front instead of back, and GetNextPerson wasn't handling infinite turns (0 or negative)
